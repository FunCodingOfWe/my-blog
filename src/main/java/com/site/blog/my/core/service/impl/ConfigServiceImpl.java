...
public class ConfigServiceImpl implements ConfigService {
    ...
    public static final String websiteLogo = "/admin/img/logo2.png";
    public static final String websiteIcon = "/admin/img/favicon.ico";

    public static final String yourAvatar = "/admin/img/favicon.ico";
